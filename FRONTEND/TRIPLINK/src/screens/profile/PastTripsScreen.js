...
const PastTripsScreen = ({
  ...
  const pastTrips = useMemo(() => {
    ...
    return confirmed.filter((b) => (b.package_status || "").toLowerCase() === "completed");
  }, [bookings]);
    ...
    <SafeAreaView style={styles.safe}>
      ...
      {loading ? (
        <View style={styles.centerWrap}>
          ...
          <Text style={styles.centerText}>Loading past trips...</Text>
        </View>
      ) : (
        <ScrollView
        ...
        >
          {mappedItems.length === 0 ? (
            <View style={styles.emptyCard}>
              <Ionicons name="airplane-outline" size={36} color="#64748b" />
              <Text style={styles.emptyTitle}>No past trips yet</Text>
              <Text style={styles.emptyText}>
                Completed trips will appear here once your booked packages have finished.
              </Text>
            </View>
          ) : (
